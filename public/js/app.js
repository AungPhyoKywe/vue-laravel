  ...
  methods: {
    fetchData: function fetchData(pageUrl) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(pageUrl).then(function (res) {
        //console.log(response);
        _this.users = res.data.data; //console.log(res.data.links);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    addPost: function addPost(index) {
      ...
      var el = document.getElementById("articles"); //for(var i=0;i<this.inputs.length;i++) {
...
/* harmony import */ var _components_articles__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/articles */ "./resources/js/components/articles.vue");
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    ...
    path: '/create',
    name: 'create',
    component: _components_articles__WEBPACK_IMPORTED_MODULE_7__["default"]
  }, {
    path: '/posts/create',
    component: _components_articles__WEBPACK_IMPORTED_MODULE_7__["default"]
  }, {
